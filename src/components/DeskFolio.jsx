...
function t0({ className: t = "" }) {
  ...
  return W(() => {
    const a = r.current;
    a && !a.textContent && (a.textContent = "Mort");
  }, []), /* @__PURE__ */ i("div", {
...
const ke = {
...
}, B = "/stickers/items/", Ie = "__component:polaroid__", Se = "__component:ipod__", _e = "__component:name-tag__", ve = [
  {
    ...
    items: [
      ...
      { src: B + "sticker-journal-1.svg", width: "clamp(80px, 18vw, 240px)", rotate: 0, pos: { top: "28%", left: "4.2%" } },
      // lined notepad
      { src: B + "sticker-journal-0.svg", width: "clamp(13px, 10vw, 46px)", rotate: 40, pos: { bottom: "15%", left: "17%" } },
      // pen
  ...
  },
  {
    ...
    items: [
      ...
      // lamp
      { src: B + "sticker-keyboard.svg", width: "clamp(139px, 33vw, 560px)", rotate: -10, pos: { top: "-3vw", left: "-7vw" } },
      // keyboard, peeking from top-left
      { src: B + "sticker-stationery-3.svg", width: "clamp(60px, 14vw, 180px)", rotate: 35, pos: { top: "60%", left: "20%" } },
      // coffee
      { src: Se, width: "clamp(92px, 8.1vw, 154px)", rotate: -14, pos: { top: "50%", right: "6%" } },
      // iPod
      { src: B + "sticker-cutie-bear.svg", width: "clamp(62px, 9.6vw, 166px)", rotate: -4, pos: { top: "62%", right: "18.3%" }, stuck: !0 },
      // bear sticker
      { src: B + "sticker-journal-1.svg", width: "clamp(80px, 18vw, 240px)", rotate: 0, pos: { top: "28%", left: "4.2%" } },
      // lined notepad
      { src: B + "sticker-desk-0.svg", width: "clamp(47px, 11.2vw, 158px)", rotate: 10, pos: { top: "42%", left: "9%" } },
      // pencil
  ...
  },
  {
    ...
    items: [
      ...
      // pencil
      { src: B + "sticker-desk-6.svg", width: "clamp(80px, 18vw, 240px)", rotate: 0, pos: { top: "28%", left: "4%" } },
      // lined note
...
const Mt = [
  ...
  },
  {
    ...
    files: [
      "sticker-dev-antigravity.svg",
      "sticker-dev-antigravity-outline.svg",
      "sticker-dev-claude.svg",
      "sticker-dev-claude-outline.svg",
...
ye.push(_e);
const Be = Mt.map((t) => ({ id: t.id, name: t.name })), Ye = (t) => /sticker-(cutie|cute-pop|dev)-/.test(t), p0 = (t) => /sticker-dev-/.test(t), u0 = "clamp(56px, 12.5vw, 132px)", Qt = B + "sticker-keyboard.svg", h0 = [
...
}), He = "https://github.com/mortspace", ut = "df-dev-activity-link";
function g0(t) {
  const r = t.trim();
...
function Dt({
  ...
  const { overrides: k, activeKey: p } = Ae(), d = k[t], h = p === t, m = (d == null ? void 0 : d.scale) ?? r.scale ?? 1, u = (d == null ? void 0 : d.rotate) ?? r.rotate ?? 0, l = (d == null ? void 0 : d.src) ?? r.src;
  if (l === Ie)
    return /* @__PURE__ */ e(
      be,
      {
  ...
  return /* @__PURE__ */ e("div", {
    className: ["df-stickers", s && "is-dragging", d && "has-active"].filter(Boolean).join(" "), children: /* @__PURE__ */ e(se, {
      children: p.map((h, m) => {
        ...
        const y = y0(h.src, Number.isFinite(u) ? u : m);
        if (h.left !== undefined) y.pos = { left: h.left, top: h.top };
        if (h.rotate !== undefined) y.rotate = h.rotate;
        if (h.scale !== undefined) y.scale = h.scale;
        return /* @__PURE__ */ e(
          Dt,
          {
            objectKey: h.key,
...
const A0 = (t) => /* @__PURE__ */ e("svg", { viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": "true", ...t, children: /* @__PURE__ */ e("path", { d: "M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" }) }), T0 = (t) => /* @__PURE__ */ e("svg", { viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": "true", ...t, children: /* @__PURE__ */ e("path", { d: "M1.763 0C.786 0 0 .786 0 1.763v20.474C0 23.214.786 24 1.763 24h20.474c.977 0 1.763-.786 1.763-1.763V1.763C24 .786 23.214 0 22.237 0zM5.13 5.323l13.837.019-.009 13.836h-3.464l.01-10.382h-3.456L12.04 19.17H5.113z" }) }), $0 = (t) => /* @__PURE__ */ e("svg", { viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": "true", ...t, children: /* @__PURE__ */ e("path", { d: "M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" }) }), O0 = (t) => /* @__PURE__ */ e("svg", { viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": "true", ...t, children: /* @__PURE__ */ e("path", { d: "M12 24C5.385 24 0 18.615 0 12S5.385 0 12 0s12 5.385 12 12-5.385 12-12 12zm10.12-10.358c-.35-.11-3.17-.953-6.384-.438 1.34 3.684 1.887 6.684 1.992 7.308 2.3-1.555 3.936-4.02 4.395-6.87zm-6.115 7.808c-.153-.9-.75-4.032-2.19-7.77l-.066.02c-5.79 2.015-7.86 6.025-8.04 6.4 1.73 1.358 3.92 2.166 6.29 2.166 1.42 0 2.77-.29 4-.814zm-11.62-2.58c.232-.4 3.045-5.055 8.332-6.765.135-.045.27-.084.405-.12-.26-.585-.54-1.167-.832-1.74C7.17 11.775 2.206 11.71 1.756 11.7l-.004.312c0 2.633.998 5.037 2.634 6.855zm-2.42-8.955c.46.008 4.683.026 9.477-1.248-1.698-3.018-3.53-5.558-3.8-5.928-2.868 1.35-5.01 3.99-5.676 7.17zM9.6 2.052c.282.38 2.145 2.914 3.822 6 3.645-1.365 5.19-3.44 5.373-3.702-1.81-1.61-4.19-2.586-6.795-2.586-.825 0-1.63.1-2.4.285zm10.335 3.483c-.218.29-1.935 2.493-5.724 4.04.24.49.47.985.68 1.486.08.18.15.36.22.53 3.41-.43 6.8.26 7.14.33-.02-2.42-.88-4.64-2.31-6.38z" }) }); const H0 = /* @__PURE__ */ i("div", {
  ...
  /* @__PURE__ */ i("div", {
    ...
    /* @__PURE__ */ e("p", { className: "df-cover-title", children: "portfolio" }),
    /* @__PURE__ */ e("span", { className: "df-cover-sub", children: "Senior UI/UX Designer" })
    ]
  }),
  /* @__PURE__ */ i("span", {
  ...
  className: "df-page", children: [
    ...
    className: "df-card", children: /* @__PURE__ */ e(
      ue,
      {
        ...
        initial: "I design products people actually enjoy using. Currently at UITOUX, turning complex problems into simple, delightful experiences. Fueled by chai and an unreasonable number of Figma tabs."
      }
    )
  }),
  ...
  className: "df-page", children: [
    ...
    /* @__PURE__ */ e("h3", { className: "df-hello df-hello--lilac", children: "Toolkit" }),
    /* @__PURE__ */ i("div", {
    ...
    className: "df-card", children: [
      ...
      className: "df-tags df-tags--blush", children: [
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Product Design" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "UI/UX Design" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "User Research" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Wireframing" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Prototyping" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Interaction Design" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Information Architecture" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Design Systems" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Figma" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Usability Testing" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "UX Strategy" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Responsive Design" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "AI-assisted Design" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Agile" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Cross-functional Collaboration" })
      ]
    })
    ]
  })
  ...
  // spread 2 left: selected work - Expense Management
  /* @__PURE__ */ i("div", {
  className: "df-page", children: [
    /* @__PURE__ */ e(pe, { className: "df-doodle df-doodle--lilac", style: { top: 2, right: 12, width: 18, height: 18 } }),
    /* @__PURE__ */ e(De, { className: "df-doodle", style: { bottom: 12, right: 28, width: 22, height: 22, transform: "rotate(-8deg)" } }),
    /* @__PURE__ */ e(st, { className: "df-doodle df-doodle--mint", style: { bottom: 16, left: 12, width: 22, height: 22 } }),
    /* @__PURE__ */ e("h3", { className: "df-hello", children: "Selected work" }),
    /* @__PURE__ */ i("div", {
    className: "df-proj df-proj--single", children: [
      /* @__PURE__ */ e("a", { href: "https://www.behance.net/gallery/247316485/Expense-Management-System", target: "_blank", rel: "noopener noreferrer", className: "df-proj-banner-link", children: /* @__PURE__ */ e("img", { src: "/images/Banner03.png", alt: "Expense Management Banner", className: "df-proj-banner df-proj-banner--large", loading: "lazy" }) }),
      /* @__PURE__ */ i("p", {
      className: "df-proj-head", children: [
        /* @__PURE__ */ e($e, { href: "https://www.behance.net/gallery/247316485/Expense-Management-System", variant: 0, children: "Expense Management" }),
        /* @__PURE__ */ e("span", { className: "df-proj-meta", children: "fintech" })
      ]
    }),
      /* @__PURE__ */ e(ue, { className: "df-edit--body df-proj-desc", placeholder: "describe it…", initial: "A modern corporate expense management platform for streamlining corporate spending and tracking." })
    ]
  })
  ]
}, "p2"),
  // spread 2 right: selected work - Roadside Assistance
  /* @__PURE__ */ i("div", {
  className: "df-page df-page--no-header", children: [
    /* @__PURE__ */ e(st, { className: "df-doodle df-doodle--mint", style: { top: 12, right: 20, width: 24, height: 24 } }),
    /* @__PURE__ */ e(pe, { className: "df-doodle df-doodle--butter", style: { bottom: 22, left: 16, width: 18, height: 18 } }),
    /* @__PURE__ */ e(De, { className: "df-doodle df-doodle--lilac", style: { bottom: 18, right: 16, width: 20, height: 20, transform: "rotate(12deg)" } }),
    /* @__PURE__ */ i("div", {
    className: "df-proj df-proj--single", children: [
      /* @__PURE__ */ e("a", { href: "https://www.behance.net/gallery/106165741/On-the-Road-Beyond-Expectation", target: "_blank", rel: "noopener noreferrer", className: "df-proj-banner-link", children: /* @__PURE__ */ e("img", { src: "/images/Banner04.png", alt: "Roadside Assistance Banner", className: "df-proj-banner df-proj-banner--large", loading: "lazy" }) }),
      /* @__PURE__ */ i("p", {
      className: "df-proj-head", children: [
        /* @__PURE__ */ e($e, { href: "https://www.behance.net/gallery/106165741/On-the-Road-Beyond-Expectation", variant: 2, children: "Roadside Assistance" }),
        /* @__PURE__ */ e("span", { className: "df-proj-meta", children: "crm app" })
      ]
    }),
      /* @__PURE__ */ e(ue, { className: "df-edit--body df-proj-desc", placeholder: "describe it…", initial: "A CRM concept designed to optimize and manage roadside assistance operations directly on the go." })
    ]
  })
  ]
}, "p3"),
  // spread 3 left: more work - Decide.AI
  /* @__PURE__ */ i("div", {
  className: "df-page df-page--no-header", children: [
    /* @__PURE__ */ e(pe, { className: "df-doodle df-doodle--butter", style: { bottom: 16, right: 12, width: 22, height: 22 } }),
    /* @__PURE__ */ e(De, { className: "df-doodle df-doodle--soft", style: { top: 8, right: 24, width: 20, height: 20, transform: "rotate(10deg)" } }),
    /* @__PURE__ */ i("div", {
    className: "df-proj df-proj--single", children: [
      /* @__PURE__ */ e("a", { href: "https://www.behance.net/gallery/246850857/DecideAI-Personal-AI-Decision-Assistant", target: "_blank", rel: "noopener noreferrer", className: "df-proj-banner-link", children: /* @__PURE__ */ e("img", { src: "/images/decideaibanner.webp", alt: "Decide.AI Banner", className: "df-proj-banner df-proj-banner--large", loading: "lazy" }) }),
      /* @__PURE__ */ i("p", {
      className: "df-proj-head", children: [
        /* @__PURE__ */ e($e, { href: "https://www.behance.net/gallery/246850857/DecideAI-Personal-AI-Decision-Assistant", variant: 3, children: "Decide.AI" }),
        /* @__PURE__ */ e("span", { className: "df-proj-meta", children: "concept study" })
      ]
    }),
      /* @__PURE__ */ e(ue, { className: "df-edit--body df-proj-desc", placeholder: "describe it…", initial: "A conceptual case study demonstrating the comprehensive product design process for an intelligent decision-support application." })
    ]
  })
  ]
}, "p-decide"),
  // spread 3 right: more work - UPI Failure Anxiety
  /* @__PURE__ */ i("div", {
  className: "df-page df-page--no-header", children: [
    /* @__PURE__ */ e(st, { className: "df-doodle df-doodle--soft df-doodle--lilac", style: { top: 14, right: 18, width: 26, height: 26 } }),
    /* @__PURE__ */ e(pe, { className: "df-doodle df-doodle--soft df-doodle--mint", style: { bottom: 64, left: 12, width: 20, height: 20 } }),
    /* @__PURE__ */ i("div", {
    className: "df-proj df-proj--single", children: [
      /* @__PURE__ */ e("a", { href: "https://www.behance.net/gallery/94504551/Failure-Anxiety-problem-in-Google-Pay-What-If", target: "_blank", rel: "noopener noreferrer", className: "df-proj-banner-link", children: /* @__PURE__ */ e("img", { src: "/images/Banner02.jpg", alt: "UPI Failure Anxiety Banner", className: "df-proj-banner df-proj-banner--large", loading: "lazy" }) }),
      /* @__PURE__ */ i("p", {
      className: "df-proj-head", children: [
        /* @__PURE__ */ e($e, { href: "https://www.behance.net/gallery/94504551/Failure-Anxiety-problem-in-Google-Pay-What-If", variant: 1, children: "UPI Failure Anxiety" }),
        /* @__PURE__ */ e("span", { className: "df-proj-meta", children: "GPay study" })
      ]
    }),
      /* @__PURE__ */ e(ue, { className: "df-edit--body df-proj-desc", placeholder: "describe it…", initial: "A concept exploring the anxiety users feel when UPI transactions fail and how Google Pay could handle it." })
    ]
  }),
    /* @__PURE__ */ i("p", {
    className: "df-sig", children: [
      /* @__PURE__ */ e($e, { href: "https://www.behance.net/balaji23", variant: 1, children: "…and more on Behance" }),
      " ",
      /* @__PURE__ */ e("span", { className: "df-heart", "aria-hidden": "true", children: "♡" })
    ]
  })
  ...
  // spread 3 left: experience
  /* @__PURE__ */ i("div", {
  className: "df-page", children: [
    /* @__PURE__ */ e(De, { className: "df-doodle df-doodle--soft", style: { top: 0, right: 12, width: 22, height: 22, transform: "rotate(-8deg)" } }),
    /* @__PURE__ */ e(pe, { className: "df-doodle df-doodle--soft df-doodle--lilac", style: { bottom: 120, right: 30, width: 16, height: 16 } }),
    /* @__PURE__ */ e(st, { className: "df-doodle df-doodle--soft df-doodle--mint", style: { bottom: 45, left: 16, width: 22, height: 22 } }),
    /* @__PURE__ */ e("h3", { className: "df-hello", children: "Experience" }),
    /* @__PURE__ */ i("div", {
    className: "df-xp-card", children: [
      /* @__PURE__ */ e("div", {
      className: "df-xp-header", children: /* @__PURE__ */ e("span", { className: "df-xp-title", children: "Senior UI/UX Designer" })
    }),
      /* @__PURE__ */ e("p", { className: "df-xp-company", children: "UITOUX Solutions Private Limited" }),
      /* @__PURE__ */ e(ue, { className: "df-edit--body df-xp-desc", placeholder: "Describe your role…", initial: "Designing end-to-end product experiences across fintech, travel, and CRM platforms. Leading UX strategy and building scalable design systems." }),
      /* @__PURE__ */ i("div", {
      className: "df-xp-stats", children: [
        /* @__PURE__ */ i("div", {
        className: "df-xp-stat", children: [
          /* @__PURE__ */ e("span", { className: "df-xp-stat-num", children: "5" }),
          /* @__PURE__ */ e("span", { className: "df-xp-stat-lbl", children: "Years" })
        ]
      }),
        /* @__PURE__ */ i("div", {
        className: "df-xp-stat", children: [
          /* @__PURE__ */ e("span", { className: "df-xp-stat-num", children: "30+" }),
          /* @__PURE__ */ e("span", { className: "df-xp-stat-lbl", children: "Products" })
        ]
      }),
        /* @__PURE__ */ i("div", {
        className: "df-xp-stat", children: [
          /* @__PURE__ */ e("span", { className: "df-xp-stat-num", children: "15+" }),
          /* @__PURE__ */ e("span", { className: "df-xp-stat-lbl", children: "Clients" })
        ]
      })
      ]
    }),
      /* @__PURE__ */ i("ul", {
      className: "df-tags df-tags--blush", children: [
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Fintech" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Travel Apps" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "CRM" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Product Design" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "E-commerce" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "Healthcare" }),
        /* @__PURE__ */ e("li", { className: "df-tag", children: "B2B Products" })
      ]
    })
    ]
  })
  ...
  className: "df-page", children: [
    ...
    /* @__PURE__ */ e(pe, { className: "df-doodle df-doodle--soft df-doodle--butter", style: { bottom: 82, left: 12, width: 20, height: 20 } }),
    /* @__PURE__ */ e(st, { className: "df-doodle df-doodle--soft df-doodle--lilac", style: { bottom: 124, right: 28, width: 24, height: 24 } }),
    /* @__PURE__ */ i("h3", {
    ...
    ue,
    {
      ...
      initial: "Got a senior product design role, a question, or just want to talk shop? I'd love to hear from you."
    }
  ),
    /* @__PURE__ */ i("div", {
    className: "df-contact-cards", children: [
      /* @__PURE__ */ i("a", {
      className: "df-contact-card df-contact-card--linkedin",
      href: "https://www.linkedin.com/in/balaji-v-8a4aa1198",
      target: "_blank",
      rel: "noreferrer",
      children: [
          /* @__PURE__ */ e("span", { className: "df-contact-pin" }),
          /* @__PURE__ */ e("svg", { viewBox: "0 0 24 24", className: "df-contact-icon", children: /* @__PURE__ */ e("path", { fill: "currentColor", d: "M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.79M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z" }) }),
          /* @__PURE__ */ e("span", { className: "df-contact-label", children: "Let's connect" }),
          /* @__PURE__ */ e("span", { className: "df-contact-sub", children: "on LinkedIn ↗" })
      ]
    }),
      /* @__PURE__ */ i("a", {
      className: "df-contact-card df-contact-card--email",
      href: "mailto:balvenkat23@gmail.com",
      target: "_blank",
      rel: "noreferrer",
      children: [
          /* @__PURE__ */ e("span", { className: "df-contact-pin" }),
          /* @__PURE__ */ e("svg", { viewBox: "0 0 24 24", className: "df-contact-icon", children: /* @__PURE__ */ e("path", { fill: "currentColor", d: "M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" }) }),
          /* @__PURE__ */ e("span", { className: "df-contact-label", children: "Drop a line" }),
          /* @__PURE__ */ e("span", { className: "df-contact-sub", children: "balvenkat23@gmail.com ↗" })
      ]
    })
    ]
  }),
...
function z0() {
  ...
  const paddedW = Math.max(0, t.w - 48), paddedH = Math.max(0, t.h - 48);
  const m = Math.min(800, Math.round(paddedW * 0.82)), u = Math.max(150, Math.round(m / 2)), l = Math.round(u * 1.34), v = Math.min(1, paddedH / (l + 376)), I = 380, w = 509, g = Math.min(paddedW * 0.8, paddedH * 0.5 / 1.34), T = g / I, O = { pageW: I, pageH: w, scale: T, w: Math.round(g), h: Math.round(g * 1.34) }, [D] = M(() => bt[Math.floor(Math.random() * bt.length)]), [A, Y] = M(D.coverId), Z = Xe.find((f) => f.id === A) ?? Xe[0], [F, _] = M(D.bgId), S = Pe.find((f) => f.id === F) ?? Pe[0];
  W(() => {
    var U;
  ...
  }), [ee, te] = M(null), [oe, le] = M([
    { key: "default-figma", src: B + "sticker-dev-figma.png", left: "85%", top: "5%", scale: 0.55, rotate: -15 },
    { key: "default-html", src: B + "sticker-dev-html.svg", left: "20%", top: "16%", scale: 0.6, rotate: -5 },
    { key: "default-js", src: B + "sticker-dev-javascript.svg", left: "10%", top: "76%", scale: 0.6, rotate: -12 }
  ]), N = z(1), [de, ce] = M(!1), Le = ne((f) => {
              ...
              !d && /* @__PURE__ */ e(se, {
                children: R === "workspace" && Me && !(x != null && x.deleted) && !b && n >= 2 && /* @__PURE__ */ i(
                  Q.div,
                  {
                    ...
                    children: [
                /* @__PURE__ */ i("span", {
                      className: "df-chalk-header-handwritten", children: [
                        "Designing",
                  /* @__PURE__ */ e("br", {}),
                        "Experiences",
                  /* @__PURE__ */ e("br", {}),
                ...
                /* @__PURE__ */ e("span", { className: "df-lamp-hint-text", children: "Learn and Build" })
                    ]
                  }
                )
              })
...
function j0() {
  const [showWarning, setShowWarning] = M(false);
  W(() => {
    const isMobile = window.matchMedia("(max-width: 760px)").matches;
    // Show warning on every mobile load (ignore previous dismissal)
    if (isMobile) {
      setShowWarning(true);
    }
  }, []);
  ...
  return /* @__PURE__ */ i("main", {
    className: "page page-bleed page-deskfolio",
    children: [
      /* @__PURE__ */ e(z0, {}),
      showWarning && /* @__PURE__ */ e("div", {
        className: "df-mobile-warning-overlay",
        children: /* @__PURE__ */ i("div", {
          className: "df-mobile-warning-card",
          children: [
            /* @__PURE__ */ e("span", { className: "df-warning-pin" }),
            /* @__PURE__ */ e("h4", { className: "df-warning-title", children: "Best on Desktop! 💻" }),
            /* @__PURE__ */ e("p", {
            className: "df-warning-text",
            children: "This site is an interactive experience built for larger screens. You can still explore on mobile, but for the full adventure — grab a laptop."
          }),
            /* @__PURE__ */ e("button", {
            className: "df-warning-btn",
            onClick: handleDismiss,
              children: "Got it, let me in"
          })
          ]
        })
      })
